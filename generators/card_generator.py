...
0. **人称约定**：卡片是给 NPC 用的，用「你」指代 NPC、「学生/对方」指代学生。Role/Context/Interaction 中不要用「我」，统一用「你」=NPC。
...
{prologue_output_section}
# Role
[用「你」指NPC：你是谁，背景、性格、说话方式]

# Context
[用「你」指NPC、「学生/对方」指学生：当前场景背景，对方扮演什么角色，正在发生什么]

# Interaction
[用「你」指NPC：你如何与学生/对方对话，如何根据对方回应推进剧情]
