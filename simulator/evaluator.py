...
评估框架（5大维度，22小维度，总分100分）：
1. 目标达成度 (18分)
2. 流程遵循度 (18分)
3. 交互体验性 (30分，含「无出戏」10分)
4. 幻觉与边界 (18分)
5. 教学策略 (16分)
"""
...
# 评估框架定义（总分 100；「无出戏」占 10 分，其余按比例分配）
EVALUATION_FRAMEWORK = {
    "目标达成度": {
        "weight": 18,
        "sub_dimensions": {
            "知识点覆盖率": {"weight": 9, "description": "教学内容的知识点是否被充分覆盖"},
            "能力覆盖率": {"weight": 9, "description": "学生能力培养目标是否达成"},
        }
    },
    "流程遵循度": {
        "weight": 18,
        "sub_dimensions": {
            ...
            "环节准出检查": {"weight": 3, "description": "离开环节时是否完成必要内容"},
            "非线性跳转处理": {"weight": 3, "description": "异常跳转时的处理是否合理"},
        }
    },
    "交互体验性": {
        "weight": 30,
        "sub_dimensions": {
            ...
            "无出戏（括号暴露思考）": {"weight": 10, "description": "智能体（NPC）回复中不得出现「出戏」行为：禁止在括号内暴露思考、元叙述或后续计划，例如「（等你回答后，我会继续追问……）」「（接下来我会问……）」等。此类内容会打破沉浸感，一律扣分；括号内为纯补充说明、术语解释或合规提示且不暴露元意图的可酌情少扣。"},
        }
    },
    "幻觉与边界": {
        "weight": 18,
        "sub_dimensions": {
            ...
            "安全围栏": {"weight": 3, "description": "是否避免敏感/不当内容"},
            "干扰抵抗": {"weight": 3, "description": "是否能抵抗学生的干扰/诱导"},
        }
    },
    "教学策略": {
        "weight": 16,
        "sub_dimensions": {
            "启发式提问频率": {"weight": 4, "description": "是否善于用问题引导思考"},
            "正向激励机制": {"weight": 4, "description": "是否给予适当的鼓励和肯定"},
            "纠错引导路径": {"weight": 4, "description": "发现错误时的纠正方式是否得当"},
            "深度追问技巧": {"weight": 4, "description": "是否能深入挖掘学生理解"},
        }
    },
}
