...
class WorkflowTester(WorkflowTesterBase):
    ...
    STUDENT_PROFILES = {
        "good": {
            "label": "优秀中医药创新创业课程的学生",
            "description": "沟通顺畅，逻辑清晰，能够理解 AI 的指令并给出有效反馈。正在参加中医药创新创业课程的路演",
            "style": "语气自然、平和且有礼貌，能够保持话题的连贯性，不杠也不水。",
            "speech_habit": "针对性回答问题，遇到不懂会具体提问，表达清晰，回复字数适中。能够输出一份5分钟左右的项目介绍。"
        },
        "medium": {
            "label": "需要引导的学生",
